'use client';
import { ANDROID, BOOKING, HOME, IOS, PRIVACY_POLICY } from '@/route';
...
export default function Footer() {
    ...
    return (
        <footer className="bg-white dark:bg-gray-800 pt-10">
            <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-4 md:p-8 lg:p-4">
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400">
                            ...
                            <li className="mb-4">
                                <Link href={PRIVACY_POLICY} className="text-gray-500 hover:underline">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400">
                            <li className="flex mb-4">
                                ...
                                <a href="tel:1900292937" className="hover:underline text-blue-500 font-bold">
                                    1900 29 29 37
                                </a>
                            </li>
                            <li className="flex mb-4">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    <div>
                        ...
                        <ul className=" text-gray-500 dark:text-gray-400">
                            ...
                            <li className="flex mb-4">
                                ...
                                >
                                    {t('UI.Branch.HaNoi.NamTuLiem.Name')} - {t('UI.Branch.HaNoi.NamTuLiem.Address')}
                                </a>
                            </li>
                        </ul>
                        <MapModal
                    ...
                    <div>
                        <Link href={HOME} className="flex mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                        ...
                        <ul className="flex space-x-5 mb-5">
                            ...
                            <li>
                                <a
                                    href="https://www.instagram.com/dymmedicalcentervn/"
                                    className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400"
                                    target="_blank"
                                >
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <p className="mb-4 text-gray-500 dark:text-gray-400">{t('UI.Footer.BRC')}</p>
                        <p className="mb-4 text-gray-500 dark:text-gray-400">{t('UI.Footer.OperateLicense')}</p>
                        <a
